			...
			<div class="gtco-container">
				<div class="row">
					...
					<div class="col-xs-2 text-right hidden-xs menu-2">
						<ul>
							<li class="btn-cta"><a href="invest.php#gtco-started"><span>Invest</span></a></li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md animate-box">
					...
					<form action="submit_ticket.php" method="POST">
						<div class="row form-group">
							<div class="col-md-6">
								<label for="fname">Unique ID (Optional)</label>
								<input type="text" id="fname" name="name" class="form-control" placeholder="UUID">
							</div>
						</div>
